...
$getfieldSydney = '?q=test&geocode=-33.885679,151.2014252,1000km&lang=en&count=100';
// $getfieldSydney = '?query=Sydney,1000km&count=100';


$twitter = new TwitterAPIExchange($settings);
$response =  $twitter->setGetfield($getfieldSydney)
